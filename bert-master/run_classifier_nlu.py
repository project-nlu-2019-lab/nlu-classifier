...
def main(
  ...
  tokenization.validate_case_matches_checkpoint(DO_LOEWR_CASE,
                                                INIT_CHECKPOINT)
  ...
  tokenizer = tokenization.FullTokenizer(
      vocab_file=VOCAB_FILE, do_lower_case=DO_LOEWR_CASE)
  ...
  if DO_PREDICT:
    ...
    for (i, prediction) in enumerate(result):
      ...
      if i >= num_actual_predict_examples:
        break
      prediction_.append([class_probability for class_probability in probabilities])
    print(prediction_)
    return prediction_
